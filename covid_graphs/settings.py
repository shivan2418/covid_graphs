"""
Django settings for covid_graphs project.
...
SECRET_KEY = 'django-insecure-*n!68te)f-c1mwiie%2^&t$amqfxfdic%gse50uxz0*t*oj-=e'
...
ROOT_URLCONF = 'covid_graphs.urls'
...
WSGI_APPLICATION = 'covid_graphs.wsgi.application'
